#!/usr/bin/env python3
"""
check_doowon_cameras_keyword.py를 위한 간단한 GUI.
...
실행:
    python3 scripts/check_doowon_cameras_keyword_gui.py
"""
...
import check_doowon_cameras_keyword as core


class App(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("두원전자통신 물품 조회 (키워드 통합검색)")
